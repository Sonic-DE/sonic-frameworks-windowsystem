 ...
 * converts it to an X11 symbol + modifiers.
 * @param keyQt the qt key code
 * @param syms the symbols will be written here; emtpy if unsuccessful
 */
KWINDOWSYSTEM_EXPORT void keyQtToSymXs(int keyQt, std::vector<int> &syms);
 ...
 * @param keyQt the qt key code
 * @param keyCodes the codes will be written here; empty if unsuccessful
 */
KWINDOWSYSTEM_EXPORT void keyQtToCodeXs(int keyQt, std::vector<int> &keyCodes);
