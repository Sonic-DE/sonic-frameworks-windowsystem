...
{
    Q_OBJECT
    Q_PROPERTY(bool isPlatformWayland READ isPlatformWayland CONSANT)
    Q_PROPERTY(bool isPlatformX11 READ isPlatformX11 CONSANT)
    Q_PROPERTY(bool isCompositing READ compositingActive NOTIFY compositingChanged)
...
public:
     ...
     *    caused this request
     */
    Q_SCRIPTABLE static void activateWindow(QWindow *window, long time = 0);
     ...
     * @since 5.83
     */
    Q_SCRIPTABLE static void requestXdgActivationToken(QWindow *win, uint32_t serial, const QString &app_id);
     ...
     * @since 5.83
     */
    Q_SCRIPTABLE static void setCurrentXdgActivationToken(const QString &token);
     ...
     * @since 5.83
     */
    Q_SCRIPTABLE static quint32 lastInputSerial(QWindow *window);
